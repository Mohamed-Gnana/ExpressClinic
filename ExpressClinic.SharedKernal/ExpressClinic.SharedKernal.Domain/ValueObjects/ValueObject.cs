...
namespace ExpressClinic.SharedKernal.Domain.ValueObjects
{
    [Serializable]
    public abstract class ValueObject : IComparable, IComparable<ValueObject>
    {
        ...
        public override int GetHashCode()
        {
            ...
            {
                _cashedHashCode = GetEqualityComponents()
        ...
        public int CompareTo(object? obj)
        {
            ...
            if (thisType is null && otherType is null)
                return 0;

            if (thisType is null && otherType is not null)
                return -1;

            if (thisType is not null && otherType is null)
                return 1;
            ...
            object[] otherComponents = other?.GetEqualityComponents().ToArray() ?? (new List<object>()).ToArray();
